...
A native macOS utility for creating bootable USB flash drives from ISO image files. Inspired by [Rufus](https://rufus.ie/) for Windows, but designed natively for the Mac ecosystem.
